...
import { GetToursLimit, GetToursOngoing } from '../../store/actions/tour'
import { useDispatch } from 'react-redux'

export const Tourongoing = () => {
  ...
  useEffect(() => {
    dispatch(GetToursOngoing(params.get('page')))
  }, [params])
