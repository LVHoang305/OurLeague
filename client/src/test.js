...
const func2 = (obj1,obj2,check) => {
  for (let i = 0; i < obj2.length; i++) {
    console.log( `Làn thứ ${i}`)
    func(obj1,obj2[i])
  }
  func3(obj1,check) 
}
...
const list = [
  {start:'9:00', end:'16:00', rate:1},
  {start:'7:00', end:'9:00', rate:1},
  {start:'8:00', end:'10:30', rate:2},
  {start:'8:00', end:'14:00', rate:1},
]

func2(list[0],list,check)
console.log(final)
